...
export const get = <T>(cell: Cell<T>): T =>
    cell.get();
export const set = <T>(cell: Cell<T>, value: T): void =>
    cell.set(value);
export const update = <T>(cell: Cell<T>, updater: (value: T) => T): void =>
    cell.update(updater);
export const subscribe = <T>(cell: Cell<T>, subscription: (value: T) => void): (() => void) =>
    cell.subscribe(subscription);
export const clone = <T>(cell: Cell<T>): Cell<T> =>
    cell.clone();
